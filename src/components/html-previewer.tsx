...
import { predefinedHtml } from "./predefienedHTML";
...
export default function HTMLPreview() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-background text-foreground bg-gray-900">
      {/* Center the HTML previewer card within the screen */}
      <div className="w-full max-w-2xl p-6 rounded-lg shadow-lg bg-card bg-white">
        ...
        <div className="grid gap-4">
          ...
          <Textarea
            ...
            className="p-4 rounded-lg border border-input bg-background text-foreground text-white bg-black"
            rows={8}
          />
          ...
          <div className="flex justify-center">
            <div className="flex gap-2 ">
              <Button
                ...
                className="text-white rounded-xl bg-gray-900 hover:text-white hover:bg-black"
              >
                Generate Preview
              </Button>
              <Button
